...
/**
 ** \file /home/juaquin/Documentos/UTEC/Ciclo6/BaseDatos2/projects/Proyecto1/parser/build/parser.tab.hh
...
#ifndef YY_YY_HOME_JUAQUIN_DOCUMENTOS_UTEC_CICLO6_BASEDATOS2_PROJECTS_PROYECTO1_PARSER_BUILD_PARSER_TAB_HH_INCLUDED
# define YY_YY_HOME_JUAQUIN_DOCUMENTOS_UTEC_CICLO6_BASEDATOS2_PROJECTS_PROYECTO1_PARSER_BUILD_PARSER_TAB_HH_INCLUDED
...
switch (yykind)
    ...
    // Implementation of make_symbol for each token kind.
      ...
      {
        return symbol_type (token::SEP, std::move (l));
      }
#else
      static
      symbol_type
      ...
      {
        return symbol_type (token::SEP, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      ...
      {
        return symbol_type (token::INDEX, std::move (l));
      }
#else
      static
      symbol_type
      ...
      {
        return symbol_type (token::PI, std::move (l));
      }
#else
      static
      symbol_type
      ...
      {
        return symbol_type (token::PI, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_PD (location_type l)
      {
        return symbol_type (token::PD, std::move (l));
      }
#else
      static
      symbol_type
      make_PD (const location_type& l)
      {
        return symbol_type (token::PD, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
...
#endif // !YY_YY_HOME_JUAQUIN_DOCUMENTOS_UTEC_CICLO6_BASEDATOS2_PROJECTS_PROYECTO1_PARSER_BUILD_PARSER_TAB_HH_INCLUDED
